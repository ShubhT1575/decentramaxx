...
import {
  ...
  extractRpcUrls,
  injected
} from "./chunk-YZHX2UCI.js";
import {
  http
} from "./chunk-JRORKTKM.js";
import {
  import_index
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-DSVXAOTA.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-HVUH5DTE.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-DELJITXK.js");
