...
import {
  en_US_default
} from "./chunk-OWZEJQGB.js";
import {
  require_dijkstra
} from "./chunk-RGPXUA2I.js";
import {
  __assign,
  __rest,
  __spreadArray,
  init_tslib_es6
} from "./chunk-4MMLBTUF.js";
import {
  mainnet
} from "./chunk-UOF4UPLM.js";
import {
  useAccount,
  useAccountEffect,
  useBalance,
...
import {
  ...
  extractRpcUrls,
  injected
} from "./chunk-EFN6RMOK.js";
import {
  import_index
} from "./chunk-QWLZ32GD.js";
import "./chunk-TJXZMLLT.js";
import {
  http
} from "./chunk-CUFGXKMR.js";
import "./chunk-6UNWIC66.js";
import {
  ripemd160,
  withRetry,
  withTimeout
} from "./chunk-W3E2MB36.js";
import {
  Field,
  FpInvertBatch,
  FpLegendre,
  ...
  secp256k1,
  weierstrassPoints
} from "./chunk-TZHMXMRR.js";
import "./chunk-DEOFGAON.js";
import "./chunk-OQEIQWDJ.js";
import {
  HashMD,
  sha256
...
import {
  require_react_dom
} from "./chunk-SM3OW2QE.js";
import {
  useQuery
} from "./chunk-YZ6YBCIC.js";
...
var require_utils = __commonJS({
  "node_modules/qrcode/lib/core/utils.js"(exports) {
    ...
    exports.getSymbolSize = function getSymbolSize(version5) {
      if (!version5) throw new Error('"version" cannot be null or undefined');
      if (version5 < 1 || version5 > 40) throw new Error('"version" should be in range from 1 to 40');
...
var require_alignment_pattern = __commonJS({
  "node_modules/qrcode/lib/core/alignment-pattern.js"(exports) {
    ...
    exports.getRowColCoords = function getRowColCoords(version5) {
      if (version5 === 1) return [];
      const posCount = Math.floor(version5 / 7) + 2;
      const size4 = getSymbolSize(version5);
...
var require_mode = __commonJS({
  "node_modules/qrcode/lib/core/mode.js"(exports) {
    ...
    exports.getCharCountIndicator = function getCharCountIndicator(mode, version5) {
      ...
      if (version5 >= 1 && version5 < 10) return mode.ccBits[0];
      else if (version5 < 27) return mode.ccBits[1];
...
var require_segments = __commonJS({
  "node_modules/qrcode/lib/core/segments.js"(exports) {
    ...
    exports.fromString = function fromString5(data, version5) {
  ...
  "node_modules/qrcode/lib/core/qrcode.js"(exports) {
    ...
    function setupFinderPattern(matrix, version5) {
      ...
      for (let i = 0; i < pos.length; i++) {
        ...
        for (let r2 = -1; r2 <= 7; r2++) {
          if (row + r2 <= -1 || size4 <= row + r2) continue;
          for (let c = -1; c <= 7; c++) {
    ...
    function createData(version5, errorCorrectionLevel, segments) {
      ...
      segments.forEach(function(data) {
        ...
        buffer2.put(data.getLength(), Mode.getCharCountIndicator(data.mode, version5));
        data.write(buffer2);
      });
      const totalCodewords = Utils.getSymbolTotalCodewords(version5);
      const ecTotalCodewords = ECCode.getTotalCodewordsCount(version5, errorCorrectionLevel);
      ...
      return createCodewords(buffer2, version5, errorCorrectionLevel);
    }
...
function fromNumber(value, options = {}) {
  const { signed: signed2, size: size4 } = options;
  ...
  const stringValue = (signed2 && value_ < 0 ? (1n << BigInt(size4 * 8)) + BigInt(value_) : value_).toString(16);
  const hex2 = `0x${stringValue.length % 2 === 0 ? stringValue : `0${stringValue}`}`;
  if (size4)
    return padLeft(hex2, size4);
  return hex2;
}
...
var IntegerOutOfRangeError = class extends BaseError {
  constructor({ max, min, signed: signed2, size: size4, value }) {
    super(`Number \`${value}\` is not in safe${size4 ? ` ${size4 * 8}-bit` : ""}${signed2 ? " signed" : " unsigned"} integer range ${max ? `(\`${min}\` to \`${max}\`)` : `(above \`${min}\`)`}`);
    Object.defineProperty(this, "name", {
      enumerable: true,
      configurable: true,
      writable: true,
...
function checksum2(address) {
  ...
  const hash8 = keccak256(fromString2(hexAddress), { as: "Bytes" });
...
function decodeNumber(cursor, param) {
  ...
  const value = cursor.readBytes(32);
  return [
    size4 > 48 ? toBigInt2(value, { signed: signed2 }) : toNumber2(value, { signed: signed2 }),
    32
  ];
}
...
async function getKey(options) {
  const { iterations = 9e5, password, salt: salt2 = randomSalt(32) } = options;
...
function from15(value) {
  let bytes2 = from2(value);
  let integer = (() => {
    let hex2 = value;
    if (value instanceof Uint8Array)
      hex2 = fromBytes(bytes2);
    return BigInt(hex2);
  })();
  let result = "";
  while (integer > 0n) {
...
function fromCreate2(options) {
  const from29 = fromHex(from5(options.from));
  const salt2 = padLeft2(validate2(options.salt) ? options.salt : fromHex(options.salt), 32);
  const bytecodeHash = (() => {
  ...
  return from5(slice(keccak256(concat2(fromHex("0xff"), from29, salt2, bytecodeHash), { as: "Hex" }), 12));
}
...
function join(separator = "") {
  ...
  return {
    encode: (from29) => {
      if (!Array.isArray(from29) || from29.length && typeof from29[0] !== "string")
...
function convertRadix(data, from29, to3) {
  if (from29 < 2)
    throw new Error(`convertRadix: wrong from=${from29}, base cannot be less than 2`);
  if (to3 < 2)
    throw new Error(`convertRadix: wrong to=${to3}, base cannot be less than 2`);
  if (!Array.isArray(data))
  ...
  while (true) {
    ...
    for (let i = pos; i < digits.length; i++) {
      ...
      const digitBase = from29 * carry + digit;
      if (!Number.isSafeInteger(digitBase) || from29 * carry / from29 !== carry || digitBase - digit !== from29 * carry) {
        throw new Error("convertRadix: carry overflow");
      }
      carry = digitBase % to3;
      const rounded = Math.floor(digitBase / to3);
      digits[i] = rounded;
...
function checksum3(len, fn) {
  ...
  return {
    encode(data) {
      ...
      const checksum4 = fn(data).slice(0, len);
      const res = new Uint8Array(data.length + len);
      res.set(data);
      res.set(checksum4, data.length);
      return res;
    },
    decode(data) {
      if (!isBytes(data))
...
function genBech32(encoding) {
  ...
  function encodeFromBytes(prefix, bytes2) {
    return encode9(prefix, toWords(bytes2));
  }
  return {
    encode: encode9,
    decode: decode5,
...
var HDKey = class _HDKey {
  ...
  static fromExtendedKey(base58key, versions = BITCOIN_VERSIONS) {
    ...
    const version5 = keyView.getUint32(0, false);
    const opt = {
      versions,
      depth: keyBuffer[4],
    ...
    if (version5 !== versions[isPriv ? "private" : "public"]) {
  ...
  serialize(version5, key) {
    if (!this.chainCode) {
      throw new Error("No chainCode set");
    }
    bytes(key, 33);
    return concatBytes(toU32(version5), new Uint8Array([this.depth]), toU32(this.parentFingerprint), toU32(this.index), this.chainCode, key);
  }
};
...
function sign2(options) {
  const { hash: hash8, payload, privateKey } = options;
  const { r: r2, s, recovery } = secp256k1.sign(from2(payload), from2(privateKey), ...hash8 ? [{ prehash: true, lowS: true }] : []);
  return {
    r: r2,
    s,
    yParity: recovery
...
function verify2(options) {
  ...
  return secp256k1.verify(signature, from2(payload), toBytes3(publicKey), ...hash8 ? [{ prehash: true, lowS: true }] : []);
}
...
var secp256r1 = p256;
var mapSWU = (() => mapToCurveSimpleSWU(Fp3, {
  A: CURVE_A,
  B: CURVE_B,
...
function sign3(options) {
  const { hash: hash8, payload, privateKey } = options;
  const { r: r2, s, recovery } = secp256r1.sign(payload instanceof Uint8Array ? payload : fromHex(payload), privateKey instanceof Uint8Array ? privateKey : fromHex(privateKey), ...hash8 ? [{ prehash: true, lowS: true }] : []);
  return {
    r: r2,
    s,
    yParity: recovery
...
function assert9(envelope) {
  ...
  if (blobVersionedHashes) {
    ...
    for (const hash8 of blobVersionedHashes) {
      ...
      const version5 = toNumber(slice(hash8, 0, 1));
      if (size4 !== 32)
...
async function sign5(options) {
  ...
  const r2 = toBigInt2(slice2(signature_bytes, 0, 32));
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-AJOX45SX.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-RKCITO3U.js");
    ...
    async getProvider() {
      async function initProvider() {
        ...
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-RGE6HBAI.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
        ...
        sdk = new MetaMaskSDK({
          ...
          ...parameters,
          readonlyRPCMap,
          dappMetadata: parameters.dappMetadata ?? (typeof window !== "undefined" ? { url: window.location.origin } : { name: "wagmi", url: "https://wagmi.sh" }),
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-P4V5VA7T.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-SNSBFM2F.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-3PNQSYH4.js");
...
var fetchTranslations = async (locale) => {
  switch (locale) {
    case "ar":
    case "ar-AR":
      return (await import("./ar_AR-EFG7DWCD-TAG64VR2.js")).default;
    case "en":
    case "en-US":
      return (await import("./en_US-762U7H2X-MYFNDKKD.js")).default;
    case "es":
    case "es-419":
      return (await import("./es_419-HHD3PTWJ-U32EYSEN.js")).default;
    case "fr":
    case "fr-FR":
      return (await import("./fr_FR-YJOM2FKT-XTZ754GW.js")).default;
    case "hi":
    case "hi-IN":
      return (await import("./hi_IN-6LCB42ZP-7VWDZWXP.js")).default;
    case "id":
    case "id-ID":
      return (await import("./id_ID-XEJUOSPY-ZHGROSDL.js")).default;
    case "ja":
    case "ja-JP":
      return (await import("./ja_JP-Y2UY5DJF-ZOL6WOMG.js")).default;
    case "ko":
    case "ko-KR":
      return (await import("./ko_KR-XEZDL32S-LMMFWVJX.js")).default;
    case "pt":
    case "pt-BR":
      return (await import("./pt_BR-URWA5SSF-RT3KF5ML.js")).default;
    case "ru":
    case "ru-RU":
      return (await import("./ru_RU-S2JHPZU4-F6BMKF6I.js")).default;
    case "th":
    case "th-TH":
      return (await import("./th_TH-ERMCTL3T-I4W3T6UI.js")).default;
    case "tr":
    case "tr-TR":
      return (await import("./tr_TR-7U4SQPKU-C5D75DY3.js")).default;
    case "ua":
    case "uk-UA":
      return (await import("./uk_UA-EWJFZZZQ-SLFSALPP.js")).default;
    case "vi":
    case "vi-VN":
      return (await import("./vi_VN-PML3AXSR-YV2PJJTW.js")).default;
    case "zh":
    case "zh-CN":
    case "zh-Hans":
      return (await import("./zh_CN-R6N3SRTH-2HNFFHCF.js")).default;
    case "zh-HK":
      return (await import("./zh_HK-ZZAF3UAE-7QOYCWBS.js")).default;
    case "zh-Hant":
    case "zh-TW":
      return (await import("./zh_TW-KSS4HRUK-XHEXCXSR.js")).default;
    default:
      return (await import("./en_US-762U7H2X-MYFNDKKD.js")).default;
  }
};
...
var arbitrumIcon = {
  ...
  iconUrl: async () => (await import("./arbitrum-IA4OWRTN-75LMK7AP.js")).default
};
var avalancheIcon = {
  iconBackground: "#e84141",
  iconUrl: async () => (await import("./avalanche-MXEFEDSW-GF3MKHG2.js")).default
};
var baseIcon = {
  iconBackground: "#0052ff",
  iconUrl: async () => (await import("./base-Z4LFBE5D-XYKXN5PC.js")).default
};
var blastIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./blast-TN2WIMWF-IXRVQ647.js")).default
};
var bscIcon = {
  iconBackground: "#ebac0e",
  iconUrl: async () => (await import("./bsc-RVE67I5L-EUF6X4PX.js")).default
};
var celoIcon = {
  iconBackground: "#FCFF52",
  iconUrl: async () => (await import("./celo-E6XU57FO-7PB6J223.js")).default
};
var cronosIcon = {
  iconBackground: "#002D74",
  iconUrl: async () => (await import("./cronos-ROYR77VZ-RUMTU47M.js")).default
};
var ethereumIcon = {
  iconBackground: "#484c50",
  iconUrl: async () => (await import("./ethereum-RFBAMUVK-AXJUXGZC.js")).default
};
var gnosisIcon = {
  iconBackground: "#04795c",
  iconUrl: async () => (await import("./gnosis-T7U5EW2Q-PPNFKSTF.js")).default
};
var hardhatIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./hardhat-NEEC6JX7-H32YEMRL.js")).default
};
var klaytnIcon = {
  iconBackground: "transparent",
  iconUrl: async () => (await import("./klaytn-QTDBZIB3-6GCRRI47.js")).default
};
var optimismIcon = {
  iconBackground: "#ff5a57",
  iconUrl: async () => (await import("./optimism-VD7XDD2W-VPFMBMZ7.js")).default
};
var mantaIcon = {
  iconBackground: "#ffffff",
  iconUrl: async () => (await import("./manta-5V6W5D7G-BV3HD5H2.js")).default
};
var mantleIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./mantle-KBL3OIYT-K7QRDRUI.js")).default
};
var polygonIcon = {
  iconBackground: "#9f71ec",
  iconUrl: async () => (await import("./polygon-WWEUOMKW-2LALZMIC.js")).default
};
var xdcIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./xdc-X7V4QFNF-EW5PBQLI.js")).default
};
var zetachainIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./zetachain-BMJKVYBN-ZERJNMOC.js")).default
};
var zkSyncIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./zkSync-JL26RB7U-GORWSRXL.js")).default
};
var zoraIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./zora-YZH32HP3-QOCMYM4T.js")).default
};
var roninIcon = {
  iconBackground: "#1273EA",
  iconUrl: async () => (await import("./ronin-PNHX5V6H-XC53GJ74.js")).default
};
...
var src = async () => (await import("./assets-NU2OP443-SDXYAFOF.js")).default;
...
var src2 = async () => (await import("./login-CWDTIDNK-DK6PSWKR.js")).default;
...
var signInIcon = async () => (await import("./sign-A7IJEUT5-OSEJM6A3.js")).default;
function SignIn({
  onClose,
  onCloseModal
}) {
...
function DialogContent({
  ...
  return import_react41.default.createElement(Box, { marginTop }, import_react41.default.createElement(
    ...
    import_react41.default.createElement(Box, { padding: padding2, paddingBottom: paddingBottom ?? padding2 }, children)
  ));
}
var units = ["k", "m", "b", "t"];
...
var src3 = async () => (await import("./connect-MR6XDLIE-3JQFJRZV.js")).default;
...
var src4 = async () => (await import("./create-X4WFHLCW-CZ27JHC5.js")).default;
...
var src5 = async () => (await import("./refresh-HJGJRASX-ADV5TXH6.js")).default;
...
var src6 = async () => (await import("./scan-DEOT2M37-R726MVUJ.js")).default;
...
var getBrowserSrc = async () => {
  ...
  switch (browser) {
    case "Arc":
      return (await import("./Arc-R3PUWRPJ-OA6YNEDS.js")).default;
    case "Brave":
      return (await import("./Brave-24BM36UM-3YH2IAJQ.js")).default;
    case "Chrome":
      return (await import("./Chrome-TLI42HDP-2PJKQIEX.js")).default;
    case "Edge":
      return (await import("./Edge-AZ34LAFM-YSNQURHM.js")).default;
    case "Firefox":
      return (await import("./Firefox-ZDK7RHKK-NZYUBOOZ.js")).default;
    case "Opera":
      return (await import("./Opera-BKMCKUXC-7AI6BIZF.js")).default;
    case "Safari":
      return (await import("./Safari-PXQIVS6N-UIILX4F4.js")).default;
    default:
      return (await import("./Browser-4R4QKTV2-5DOWTQ5X.js")).default;
  }
};
...
var getPlatformSrc = async () => {
  ...
  switch (platform) {
    case "Windows":
      return (await import("./Windows-GTAT3OTE-AO4IDO7Y.js")).default;
    case "macOS":
      return (await import("./Macos-5QL4JBJE-XICII5AO.js")).default;
    case "Linux":
      return (await import("./Linux-VYP66PDO-MM6GBEFS.js")).default;
    default:
      return (await import("./Linux-VYP66PDO-MM6GBEFS.js")).default;
  }
};
...
var coinbaseWallet2 = ({ appName, appIcon }) => {
  ...
  return {
    ...
    shortName: "Coinbase",
    rdns: "com.coinbase.wallet",
    iconUrl: async () => (await import("./coinbaseWallet-WWX6LF36-2PM4PFND.js")).default,
    iconAccent: "#2c5ff6",
...
var metaMaskWallet = ({
  ...
  return {
    ...
    name: "MetaMask",
    rdns: "io.metamask",
    iconUrl: async () => (await import("./metaMaskWallet-YFHEHW7V-X37EU3FI.js")).default,
    iconAccent: "#f6851a",
    iconBackground: "#fff",
...
var rainbowWallet = ({
  ...
  return {
    ...
    name: "Rainbow",
    rdns: "me.rainbow",
    iconUrl: async () => (await import("./rainbowWallet-2SR6TVBF-TK5H6G36.js")).default,
...
var safeWallet = () => ({
  ...
  iconAccent: "#12ff80",
  iconBackground: "#fff",
  iconUrl: async () => (await import("./safeWallet-VUYZPLY4-4DOQA5ZD.js")).default,
  installed: (
...
var walletConnectWallet = ({
  ...
  return {
    ...
    name: "WalletConnect",
    installed: void 0,
    iconUrl: async () => (await import("./walletConnectWallet-FNSU4KNU-XKHSALHV.js")).default,
