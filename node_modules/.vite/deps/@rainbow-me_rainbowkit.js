...
import {
  en_US_default
} from "./chunk-DFA7TKOZ.js";
import {
  require_dijkstra
} from "./chunk-KBBIH74C.js";
import {
  __assign,
  __rest,
  __spreadArray,
...
import {
  ...
  useSignMessage,
  useSwitchChain
} from "./chunk-7FNELGGU.js";
import {
  require_react_dom
} from "./chunk-J4NESBNT.js";
import {
  useQuery
} from "./chunk-FK2QYU3F.js";
...
import {
  ...
  extractRpcUrls,
  injected
} from "./chunk-NSCSY2RK.js";
import {
  http
} from "./chunk-UGBOH6JO.js";
import {
  import_index
} from "./chunk-YOLEXXBR.js";
import "./chunk-M6JLZ5G3.js";
import "./chunk-ULMC2L2N.js";
import {
  ...
  withRetry,
  withTimeout
} from "./chunk-RSE6N7CT.js";
import {
  ripemd160
} from "./chunk-C4QPDNCK.js";
import {
  Field,
  FpInvertBatch,
  FpLegendre,
  ...
  secp256k1,
  weierstrassPoints
} from "./chunk-5APWQE7X.js";
import "./chunk-XUAVO3BR.js";
import "./chunk-5YLCP2UP.js";
import {
...
import {
  ...
  parseAbi,
  u64_default
} from "./chunk-IRIDC7YZ.js";
import {
  HashMD,
  sha256
} from "./chunk-B47TRCNG.js";
import {
  Hash,
  abytes,
  aexists,
...
var require_reed_solomon_encoder = __commonJS({
  "node_modules/qrcode/lib/core/reed-solomon-encoder.js"(exports, module) {
    ...
    ReedSolomonEncoder.prototype.encode = function encode7(data) {
      if (!this.genPoly) {
...
var require_qrcode = __commonJS({
  "node_modules/qrcode/lib/core/qrcode.js"(exports) {
    ...
    exports.create = function create4(data, options) {
    ...
    if (args_.length > 0) {
      ...
      topics = (indexedInputs == null ? void 0 : indexedInputs.map((param, i) => {
        if (Array.isArray(args_[i]))
          return args_[i].map((_, j) => encode7(param, args_[i][j]));
        return typeof args_[i] !== "undefined" && args_[i] !== null ? encode7(param, args_[i]) : null;
      })) ?? [];
    }
  }
  const selector = (() => {
...
function chain(...args) {
  ...
  const encode7 = args.map((x) => x.encode).reduceRight(wrap, id);
...
function genBech32(encoding) {
  ...
  function encode7(prefix, words, limit = 90) {
  ...
  function encodeFromBytes(prefix, bytes) {
    return encode7(prefix, toWords(bytes));
  }
  return {
    encode: encode7,
    decode: decode4,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-MS54ZO7L.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-JKKHTM3L.js");
    ...
    async getProvider() {
      async function initProvider() {
        ...
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-4NEMEJD4.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-YH6L72CY.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-AAFIX5AS.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-2H6WOFJL.js");
...
var fetchTranslations = async (locale) => {
  switch (locale) {
    case "ar":
    case "ar-AR":
      return (await import("./ar_AR-ZRPPM56D-MP76NVWS.js")).default;
    case "de":
    case "de-DE":
      return (await import("./de_DE-GYZFZXWH-IKRRTR2Z.js")).default;
    case "en":
    case "en-US":
      return (await import("./en_US-AV7YDYDW-4WOI5RWA.js")).default;
    case "es":
    case "es-419":
      return (await import("./es_419-OGVOQEFZ-KOHKUK77.js")).default;
    case "fr":
    case "fr-FR":
      return (await import("./fr_FR-Q5QBQBX2-VBELRUFL.js")).default;
    case "hi":
    case "hi-IN":
      return (await import("./hi_IN-7I7LRHGW-YEBW6BLD.js")).default;
    case "id":
    case "id-ID":
      return (await import("./id_ID-ZMGZ2JFV-C4G6KTN6.js")).default;
    case "ja":
    case "ja-JP":
      return (await import("./ja_JP-NYBCHQTZ-3L3RQV4C.js")).default;
    case "ko":
    case "ko-KR":
      return (await import("./ko_KR-67WE736M-UFNI2GOZ.js")).default;
    case "ms":
    case "ms-MY":
      return (await import("./ms_MY-65AJIBUS-VEMQIP3Z.js")).default;
    case "pt":
    case "pt-BR":
      return (await import("./pt_BR-DMJANC65-SNNMHPFJ.js")).default;
    case "ru":
    case "ru-RU":
      return (await import("./ru_RU-WER7RQ6A-SCJOESI7.js")).default;
    case "th":
    case "th-TH":
      return (await import("./th_TH-JOSHEZ6D-YDXJAB37.js")).default;
    case "tr":
    case "tr-TR":
      return (await import("./tr_TR-EAMG2YPO-U423MTPL.js")).default;
    case "ua":
    case "uk-UA":
      return (await import("./uk_UA-GO2TRVWA-JMGPGBCR.js")).default;
    case "vi":
    case "vi-VN":
      return (await import("./vi_VN-5HLLSOJA-L4L4ZIJT.js")).default;
    case "zh":
    case "zh-CN":
    case "zh-Hans":
      return (await import("./zh_CN-THPIFVWJ-RWHSVPYW.js")).default;
    case "zh-HK":
      return (await import("./zh_HK-R7XP4TGF-UNR2M4PS.js")).default;
    case "zh-Hant":
    case "zh-TW":
      return (await import("./zh_TW-F5LD752V-7JAGV3XS.js")).default;
    default:
      return (await import("./en_US-AV7YDYDW-4WOI5RWA.js")).default;
  }
};
...
var apeChainIcon = {
  ...
  iconUrl: async () => (await import("./apechain-COEQ5RUI-V4PNKF46.js")).default
};
var arbitrumIcon = {
  iconBackground: "#96bedc",
  iconUrl: async () => (await import("./arbitrum-HW44W6XR-LTKCVCUC.js")).default
};
var avalancheIcon = {
  iconBackground: "#e84141",
  iconUrl: async () => (await import("./avalanche-MXEFEDSW-GZODS5LC.js")).default
};
var baseIcon = {
  iconBackground: "#0052ff",
  iconUrl: async () => (await import("./base-Z4LFBE5D-UMCN5FZO.js")).default
};
var berachainIcon = {
  iconBackground: "#814625",
  iconUrl: async () => (await import("./berachain-ZN3U5LDZ-IWR5I6B6.js")).default
};
var blastIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./blast-46UQLYYY-U2ZN6X5J.js")).default
};
var bscIcon = {
  iconBackground: "#ebac0e",
  iconUrl: async () => (await import("./bsc-RVE67I5L-TXLO25W7.js")).default
};
var celoIcon = {
  iconBackground: "#FCFF52",
  iconUrl: async () => (await import("./celo-E6XU57FO-YZZOYEDZ.js")).default
};
var cronosIcon = {
  iconBackground: "#002D74",
  iconUrl: async () => (await import("./cronos-ROYR77VZ-HIL62R2X.js")).default
};
var degenIcon = {
  iconBackground: "#A36EFD",
  iconUrl: async () => (await import("./degen-7ROC3GCY-CPFE7LJJ.js")).default
};
var ethereumIcon = {
  iconBackground: "#484c50",
  iconUrl: async () => (await import("./ethereum-RFBAMUVK-KYXGCDJW.js")).default
};
var flowIcon = {
  iconBackground: "transparent",
  iconUrl: async () => (await import("./flow-NBCRNYVF-Y5RTTQGE.js")).default
};
var gnosisIcon = {
  iconBackground: "#04795c",
  iconUrl: async () => (await import("./gnosis-Y56LN66M-SHBZFRUU.js")).default
};
var gravityIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./gravity-LMEBVSFN-BCYKWN7I.js")).default
};
var hardhatIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./hardhat-NEEC6JX7-A4O5Z5VG.js")).default
};
var hyperevmIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./hyperevm-J6CONVCX-CKIVDUPB.js")).default
};
var inkIcon = {
  iconBackground: "#7132F5",
  iconUrl: async () => (await import("./ink-4U4ZVNAB-PS3CR4IR.js")).default
};
var kaiaIcon = {
  iconBackground: "transparent",
  iconUrl: async () => (await import("./kaia-A33DVQBT-JZA2ZBQ6.js")).default
};
var lineaIcon = {
  iconBackground: "#ffffff",
  iconUrl: async () => (await import("./linea-IALBSJQC-5UEV3FIU.js")).default
};
var mantaIcon = {
  iconBackground: "#ffffff",
  iconUrl: async () => (await import("./manta-5V6W5D7G-3EYV4QQT.js")).default
};
var mantleIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./mantle-KBL3OIYT-NEK7JUNB.js")).default
};
var optimismIcon = {
  iconBackground: "#ff5a57",
  iconUrl: async () => (await import("./optimism-YWJ3IQHA-RQR7R24M.js")).default
};
var polygonIcon = {
  iconBackground: "#9f71ec",
  iconUrl: async () => (await import("./polygon-WWEUOMKW-NL3MGBGF.js")).default
};
var roninIcon = {
  iconBackground: "#1273EA",
  iconUrl: async () => (await import("./ronin-PNHX5V6H-BG5NAHQQ.js")).default
};
var sankoIcon = {
  iconBackground: "#000000",
...
var scrollIcon = {
  ...
  iconUrl: async () => (await import("./scroll-MCKFTBRS-ZWSMU7IE.js")).default
};
var unichainIcon = {
  iconBackground: "#F50DB4",
  iconUrl: async () => (await import("./unichain-OQ3BZUDH-UKVS6M4R.js")).default
};
var xdcIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./xdc-X7V4QFNF-TB3U6MI5.js")).default
};
var zetachainIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./zetachain-BMJKVYBN-DNXYKRKB.js")).default
};
var zkSyncIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./zksync-UWUXFL74-UYVVROB4.js")).default
};
var zoraIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./zora-YZH32HP3-6JJZ26OT.js")).default
};
...
function useFingerprint() {
  const fingerprint = (0, import_react31.useCallback)(() => {
    setRainbowKitVersion({ version: "2.2.4" });
  }, []);
...
var src = async () => (await import("./assets-NU2OP443-B2DMNXPX.js")).default;
...
var src2 = async () => (await import("./login-CWDTIDNK-3422JDIG.js")).default;
...
var src3 = async () => (await import("./connect-MR6XDLIE-X6PK72D5.js")).default;
...
var src4 = async () => (await import("./create-X4WFHLCW-K4PQ4DLV.js")).default;
...
var src5 = async () => (await import("./refresh-HJGJRASX-MRTQ5VRP.js")).default;
...
var src6 = async () => (await import("./scan-DEOT2M37-7AXLDU5N.js")).default;
...
var getBrowserSrc = async () => {
  ...
  switch (browser) {
    case "Arc":
      return (await import("./Arc-R3PUWRPJ-L7TMGRTO.js")).default;
    case "Brave":
      return (await import("./Brave-24BM36UM-TN4JLGFI.js")).default;
    case "Chrome":
      return (await import("./Chrome-TLI42HDP-SKP3O22O.js")).default;
    case "Edge":
      return (await import("./Edge-AZ34LAFM-GO3KASGY.js")).default;
    case "Firefox":
      return (await import("./Firefox-ZDK7RHKK-OA6SZOYA.js")).default;
    case "Opera":
      return (await import("./Opera-BKMCKUXC-DVNVLSIH.js")).default;
    case "Safari":
      return (await import("./Safari-PXQIVS6N-OX4LT4N2.js")).default;
    default:
      return (await import("./Browser-4R4QKTV2-SWJF34BA.js")).default;
  }
};
...
var getPlatformSrc = async () => {
  ...
  switch (platform) {
    case "Windows":
      return (await import("./Windows-GTAT3OTE-33IVLGSY.js")).default;
    case "macOS":
      return (await import("./Macos-5QL4JBJE-BNRU2UZ2.js")).default;
    case "Linux":
      return (await import("./Linux-VYP66PDO-VQLPQRLD.js")).default;
    default:
      return (await import("./Linux-VYP66PDO-VQLPQRLD.js")).default;
  }
};
...
var coinbaseWallet2 = ({ appName, appIcon }) => {
  ...
  return {
    ...
    shortName: "Coinbase",
    rdns: "com.coinbase.wallet",
    iconUrl: async () => (await import("./coinbaseWallet-WWX6LF36-LTDJISQ6.js")).default,
    iconAccent: "#2c5ff6",
...
var metaMaskWallet = ({
  ...
  return {
    ...
    name: "MetaMask",
    rdns: "io.metamask",
    iconUrl: async () => (await import("./metaMaskWallet-YFHEHW7V-T66FE3XT.js")).default,
    iconAccent: "#f6851a",
    iconBackground: "#fff",
...
var rainbowWallet = ({
  ...
  return {
    ...
    name: "Rainbow",
    rdns: "me.rainbow",
    iconUrl: async () => (await import("./rainbowWallet-2SR6TVBF-DPDDJBPU.js")).default,
...
var safeWallet = () => ({
  ...
  iconAccent: "#12ff80",
  iconBackground: "#fff",
  iconUrl: async () => (await import("./safeWallet-VUYZPLY4-POLBUVDG.js")).default,
  installed: (
...
var walletConnectWallet = ({
  ...
  return {
    ...
    name: "WalletConnect",
    installed: void 0,
    iconUrl: async () => (await import("./walletConnectWallet-FNSU4KNU-QNDUKNPV.js")).default,
