          ...
          <div className="card-body active-tab">
            <div className="table-responsive">
              <table className="table table-bordered text-nowrap mb-0">
                <thead>
                  <tr>
                    <th scope="col" style={{color: "white"}}>Tx Hash</th>
                    ...
                    <th scope="col" style={{color: "white"}}>Time Stamp</th>
                  </tr>
                </thead>
                <tbody>
              ...
              {paginatedTable1?.length === 0 && (
                <div className=" w-100">
                  <div className="w-100 text-center p-3 color-light">No Data Found.</div>
                </div>
              )}
            </div>
          </div>
